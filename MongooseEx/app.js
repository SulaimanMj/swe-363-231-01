...
mongoose.connect('mongodb+srv://SulaimanMj:Suliman996633@cluster0.8oed6js.mongodb.net/?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true })
   ...
   async function updateItem(id, newName) {
    ...
    name: newName }, {
       ...
       async function performCRUDOperations() {
        ...
        console.error('Error in CRUD operations:', error);  } finally {
